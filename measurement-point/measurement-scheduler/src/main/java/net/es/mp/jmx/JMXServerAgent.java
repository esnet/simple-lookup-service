 ...
 * They can be set with the System properties mp.jmx.host and mp.jmx.port
 ...
 * 
 * java -Xmx256m -Dmp.jmx.port=8080 -Dmp.jmx.host=localhost -javaagent:target/measurement-scheduler-0.1-jmx.jar 
 *      -Djava.net.preferIPv4Stack=true -jar target/measurement-scheduler-0.1.one-jar.jar  $*
 * 
...
public class JMXServerAgent {
    ...
    public static void premain(String agentArgs)  throws IOException{
        int port= Integer.parseInt(
                System.getProperty("mp.jmx.port","3000"));
        String host = System.getProperty("mp.jmx.host",InetAddress.getLocalHost().getHostName());
